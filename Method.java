 ...
 * Computing Lab. Work
 * Coursework No.   : 02
 * Student ID       : 5026231100
 * Student Name     : Defita Aulia Syarif
 * Class            : B
 * Cohort           : A
 */
...
public class Method {
    ...
    public static void task3(){
        ...
        double totalPrice = numOfTea*priceOfTea*(1-discountOfTea)+numOfCoffee*priceOfCoffee*(1-discountOfCoffee)+numOfPizza*priceOfPizza*(1-discountOfPizza);
        // count the total price after tax
        double totalPriceAfterTax = totalPrice*(100+tax)/100;
        // print total price
        ...
        System.out.println("Tea \t|\t" + numOfTea + "\t|\t"  + numOfTea*priceOfTea*(1-discountOfTea));
        System.out.println("Coffee\t|\t" + numOfCoffee + "\t|\t"  + numOfCoffee*priceOfCoffee*(1-discountOfCoffee));
        System.out.println("Pizza\t|\t" + numOfPizza + "\t|\t"  + numOfPizza*priceOfPizza*(1-discountOfPizza));
    ...
    public static void task4(String input){
        // Your code goes here
        int spasiPertama = input.indexOf(" ");
        int spasiKedua = input.indexOf(" ", spasiPertama+1);
        String word1 = input.substring(0, spasiPertama);
        String word2 = input.substring(spasiKedua+1);
        String is = input.substring(spasiPertama, spasiKedua+1);
        word1 = word1.toLowerCase();
        String firstLetter = ""+word2.charAt(0);
        word2 = firstLetter.toUpperCase() + word2.substring(1);

        System.out.println(word2 + is + word1);
    }
}
